/**
 * ValidationException Class This utility class provides methods for handling
 * validation exceptions and converts constraint violations into a custom
 * exception with error messages.
 */
...
public class ValidationException {
    /**
     * Handles constraint violations and converts them into a custom exception with
     * error messages.
     * @param  fieldViolations A set of constraint violations.
     * @throws CustomException if constraint violations are found, containing error
     *                         messages.
     */
