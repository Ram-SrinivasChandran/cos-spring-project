...
/**
 * CustomException is an extended RuntimeException class used to handle custom exceptions in the application.
 */
@Data
...
public class CustomException extends RuntimeException {
    ...
    /**
     * Constructs a CustomException with a single error message and an HTTP status code.
     *
    ...
    /**
     * Constructs a CustomException with a list of error messages and an HTTP status code.
     *
