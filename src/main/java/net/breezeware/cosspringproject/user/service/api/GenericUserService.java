...
/**
 * The `GenericUserService` interface provides a generic set of methods for managing entities in the system.
 * It defines common operations for retrieving, saving, updating, and deleting entities.
 *
