...
/**
 * The `UserAddressMapService` interface extends the `GenericUserService`
 * interface for managing user address mapping in the system. It provides
 * methods for handling user address mapping entities.
 */
