...
public class FoodMenuController {
    ...
    @Parameter(allowEmptyValue = false, name = "food-menu-id", description = "Food Menu Extraction Using Food Menu Id", required = true,
    ...
    @io.swagger.v3.oas.annotations.parameters.RequestBody(
            content = { @Content(mediaType = "application/json", schema = @Schema(implementation = FoodMenu.class)) })
    @Parameters({
            @Parameter(allowEmptyValue = false, name = "food-menu-id", description = "Food Menu to be Updated", required = true,
                    in = ParameterIn.PATH),
    ...
    @ApiResponses(
            value = {
                    @ApiResponse(responseCode = "204", description = "Food Menu Updated",
                            content = @Content),
                    @ApiResponse(responseCode = "400", description = "Invalid Food Menu Id",
                            content = { @Content(mediaType = "application/json", schema = @Schema(example = """
                                {
    ...
    @ApiResponses(
            value = {
                    @ApiResponse(responseCode = "200", description = "Food Menu Deleted",
                            content = @Content),
                    @ApiResponse(responseCode = "400", description = "Invalid Food Menu Id",
                            content = { @Content(mediaType = "application/json", schema = @Schema(example = """
                                {
