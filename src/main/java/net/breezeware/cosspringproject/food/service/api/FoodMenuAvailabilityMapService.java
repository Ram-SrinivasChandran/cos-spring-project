...
/**
 * The `FoodMenuAvailabilityMapService` interface defines the contract for managing associations between food menus and availability.
 */
public interface FoodMenuAvailabilityMapService {
     ...
     *
     * @param foodMenuAvailabilityMapId The unique identifier of the food menu availability mapping to find.
     * @return The found food menu availability mapping or `null` if not found.
     */
     ...
     *
     * @param foodMenuAvailabilityMapId The unique identifier of the food menu availability mapping to delete.
     */
     ...
     * @return A list of food menu availability mappings associated with the given food menu.
     */
    List<FoodMenuAvailabilityMap> getFoodMenuAvailabilityMapByFoodMenu(FoodMenu foodMenu);

    /**
     * Get all food menu availability mappings associated with a specific availability.
     *
     * @param availability The availability for which to retrieve food menu mappings.
     * @return A list of food menu availability mappings associated with the given availability.
     */
