...
/**
 * The `FoodMenuFoodItemMapService` interface defines the contract for managing
 * associations between food menus and food items.
 */
public interface FoodMenuFoodItemMapService {
     ...
     * @param  foodMenuFoodItemMapId The unique identifier of the food menu food
     *                               item mapping to find.
     * @return                       The found food menu food item mapping or `null`
     *                               if not found.
     */
     ...
     * @return          A list of food menu food item mappings associated with the
     *                  given food menu.
     */
     ...
     * @param foodMenuFoodItemMapId The unique identifier of the food menu food item
     *                              mapping to delete.
     */
